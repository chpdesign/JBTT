package tracker.util.htmlcode;

import tracker.util.bbcode.AbstractCode;
import tracker.util.bbcode.BBCodes;
import tracker.util.bbcode.Tag;
...
public class HtmlString {
	...
	protected void filter() {
		...
		// <span style="text-decoration: none; text-align: center; color: #000;"></span>

		String commonRegex = "<(|/)\\s*?(\\w+?)\\s*?(|/)>";
